  ...
  return (
    <div>
      ...
      <div className="relative z-50 mt-[-1.5rem] flex items-center justify-between rounded-tl-3xl rounded-tr-3xl bg-white px-5 pt-5">
        ...
        <div className="left-2 top-2 flex gap-[3px] rounded-full bg-foreground px-2 py-[2px] text-white">
      ...
      <div className="mt-3 flex gap-4 overflow-x-scroll px-5 [&::-webkit-scrollbar]:hidden">
        {restaurant.categories.map((category) => (
          <div
            className="min-w-[167px] bg-[#f4f4f4] text-center"
            key={category.id}
          >
      ...
      <div className="mt-6 space-y-4">
        {/*TODO: mostrar produtos mois pedidos */}
